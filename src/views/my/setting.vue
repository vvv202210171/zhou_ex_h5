...
<template>
  <div>
    ...
    <van-action-sheet v-model="langSheet" :actions="langList" @select="onSelectLang" :cancel-text="$t('commonLang.lang1')" />
    ...
    <van-popup class="right_popup" v-model="userAgreementPopup" position="right" close-on-popstate overlay-class="block_bg">
      <nav-header :title="$t('accountLang.lang25')" />
      <div class="main_content">
        <userAgreement />
      </div>
    </van-popup>
    <van-popup class="right_popup" v-model="privacyPolicyPopup" position="right" close-on-popstate overlay-class="block_bg">
