      ...
      <div class="record_top_box">
        <div class="balance_box">
          ...
          <div class="flex_between">
            ...
            <span>{{ ((Number(coinBalance.usable) + Number(coinBalance.disable)) * coinBalance.usdt
              * rateData.price) |mathFloor(2) }}</span>
          </div>
        </div>
      </div>
      <van-tabs v-model="active" border :sticky="isSticky" :offset-top="headerHeight" swipeable line-width="20"
        line-height="2">
